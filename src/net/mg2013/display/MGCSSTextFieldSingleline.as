package net.mg2013.display
{
	...
	{
		public function MGCSSTextFieldSingleline(_css:StyleSheet, _width:Number, _height:Number, _text:String = "", _autoSizeLeft:Boolean = true, _mouseEnabled:Boolean = false, _selectable:Boolean = false, _wordWrap:Boolean = false, _id:String = null, collectionType:int = MGTextFieldCollectionTypes.SKIP_COLLECTION)
		{
