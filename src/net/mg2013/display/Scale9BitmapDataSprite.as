package net.mg2013.display
{
    ...
    public class Scale9BitmapDataSprite extends SpriteStageEvents implements ISpriteStageEvents
    {
        ...
        private var __marginLeft:Number = 0;

        private var __marginTop:Number = 0;

        private var __marginRight:Number = 0;

        private var __marginBottom:Number = 0;
        ...
        public function Scale9BitmapDataSprite(bitmapData:BitmapData, scale9Rect:Rectangle = null, repeatTexture:Boolean = false)
        {
            ...
            if (scale9Rect)
            {
                __marginLeft = scale9Rect.x;
                __marginTop = scale9Rect.y;
                __marginRight = __width - __marginLeft - scale9Rect.width;
                __marginBottom = __height - __marginTop - scale9Rect.height;
            }
            initShapes();
        }
